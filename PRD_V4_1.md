...
Janela útil de microestrutura: **2023-05 → 2025-11, ~30 meses**, idêntica nos cinco. Grupo F permanece fora do T1 (§2.7.1 do V3.2). Simulador de fila restrito à mesma janela.
...
Todos os 28 verdes usam fill de **97,1%**; o real medido é **42,2%**.

Não há `bookTicker` fora de 2023-05 → 2025-11. A medição **quantifica a incerteza**, não a resolve:
