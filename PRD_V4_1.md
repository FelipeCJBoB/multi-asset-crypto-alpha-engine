...
| 6 | DSR final < 0,50 | encerrar — **nota 2026-08-28**: critério de ENCERRAMENTO (abandonar), não revogado por `AG-077` (que redefine só o Gate 6 POSITIVO de "pronto"/sucesso, ver `V41-12` acima); não confundir os dois |
...
| V41-12 | ~~DSR final com `N_lifetime` = 60~~ — **SUPERADO 2026-08-28** (`AG-077`): "pronto" redefinido para "lucro em Live Demo", ver `PLANO_MESTRE_PRINCE2.md` §11.4 e `audit/architecture_gaps_log.yaml::AG-077`/`AG-374` | 0 | **Gate 6** |
