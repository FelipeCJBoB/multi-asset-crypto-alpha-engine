...
- `audit/n_lifetime.yaml::counter = 45`; teto **60**; critério de encerramento #5 (`PRD_V4_1.md:670`): *"`N_lifetime > 60` sem Camada 2 fechada → encerrar — orçamento exaurido"*. **15 trials restantes.**
