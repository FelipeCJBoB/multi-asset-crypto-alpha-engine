...
def run_layer1_sprint(
    *,
    ...
    # AG-457 -- o vies de -13,0% citado abaixo esta OBSOLETO: foi medido
    # sob `sample_weight = uniqueness * |ret_net|`, que nao e mais o peso
    # vigente. Remedido em 20 celulas sobre os labels da Fase A, o vies
    # maximo cai de 6,91pp para 0,74pp sob `|ret_gross|`. `uniqueness`
    # segue sendo a base, agora por medicao (0,50pp, o mais apertado dos
    # tres) e nao por heranca -- nota completa em alpha.py.
